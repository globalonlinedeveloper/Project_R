...
| R-G3 | IRT calibration (how hard each item is) | Must | Stage3 | Build-ahead 🟦 | 🔒 owner/$$ | `calibration.dart`, `irt.dart`, `calibration_joint_test.dart`, `calibration_test.dart` +1 |
