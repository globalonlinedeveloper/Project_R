...
| R-G6 | Learner-state entities (what gets stored) | Must | Stage3 | Build-ahead 🟦 | 🔒 owner/$$ | `learner_state.dart`, `user.schema.json`, `user_item_state.schema.json`, `learner_state_test.dart` |
