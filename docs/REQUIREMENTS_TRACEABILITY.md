...
| R-G3 | IRT calibration (how hard each item is) | Must | Stage3 | Build-ahead 🟦 | 🔒 owner/$$ | `supabase_calibration_store.dart`, `calibration.dart`, `calibration_runner.dart`, `irt.dart` +4 |
