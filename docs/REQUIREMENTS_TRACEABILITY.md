...
| R-G3 | IRT calibration (how hard each item is) | Must | Stage3 | Build-ahead 🟦 | 🔒 owner/$$ | `calibration.dart`, `calibration_runner.dart`, `irt.dart`, `calibration_joint_test.dart` +3 |
