...
| R-G2 | theta ability model (global + per-skill) | Must | Stage3 | Build-ahead 🟦 | 🔒 owner/$$ | `placement_controller.dart`, `ability.dart`, `ability_test.dart` |
...
| R-G9 | Saved words - flashcards - graded review | Should | Stage3 | Build-ahead 🟦 | 🔒 owner/$$ | `saved_words_controller.dart`, `saved_words.dart`, `saved_words_test.dart` |
