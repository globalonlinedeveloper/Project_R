...
/// S133 (EN answer-leak fix): the EN course's 12 authored roleplays (2 per band
/// A1–C2) load through the fail-closed loader and project structurally sound —
/// every graded turn has exactly one correct reply and every branch resolves.
///
/// THE GUARD: a you-turn's line is a PROMPT, never the leaked answer. S132's QA
/// found the oldest roleplay (scenario_en_a1_meet) had reused the lesson
...
/// This permanent test covers all 23 you-scenes so the leak can never return.
/// (Ground-truth note: only that one scene leaked; the other 11 roleplays were
/// already authored with honest "How do you…?" prompts.) [R-D10 · R-B3]
void main() {
  ...
  test('the fixed a1_meet roleplay prompts honestly, answer intact', () {
