...
void main() {
  ...
  test('initContentOverrides loads the REQUESTED course (en)', () async {
    ...
    expect(spine.units.length, 42); // A1 + A2 + B1 (S1+S2) + B2 S1 authored curriculum (S99)
  });
  ...
  testWidgets('RatelCourseRoot switches es -> en restart-free',
    ...
    // The scope remounted onto the EN spine — 42 authored units, no restart.
    expect(find.text('course:en units:42'), findsOneWidget);
